<template>
  <div class="user_wrapper view_wrapper">
    <div class="msg_box">
      <div @click="clickThis(14)"
           class="msg_icon"></div>
    </div>
    <div class="user">
      <div class="top">
        <div class="info">
          <div @click="clickThis(13)"
               class="avator">
            <ims-image class="img"
                       lazy
                       :src=" account.headPortrait || require('../../assets/user.png')" />
            <img v-if="isLogin"
                 class="img_edit"
                 src="./img/icon_mine_editor.png">
          </div>
          <div v-if="isLogin"
               class="name_id">
        ...
        <div class="options">
          ...
          <div class="opts">
            <div @click="clickThis(10)"
                 class="opt">
              <img class="img"
                   src="./img/icon_new_mine_desposit.png">
              <p class="p">存款</p>
            </div>
            ...
            <div @click="clickThis(11)"
                 class="opt">
              <img class="img"
                   src="./img/icon_new_mine_withdraw.png">
              <p class="p">取款</p>
            </div>
            <div @click="clickThis(12,false)"
                 class="opt">
              <img class="img"
                   src="./img/icon_new_mine_discount.png">
              <p class="p">优惠</p>
            </div>
          </div>
        </div>
      ...
      <div class="btns">
        <div @click="clickThis(0)"
             class="btn">
          <img class="img"
               src="./img/icon_new_mine_personal.png">
          <p class="p">个人资料</p>
        </div>
        <div class="linear"></div>
        <div @click="clickThis(1)"
             class="btn">
          <img class="img"
               src="./img/icon_new_mine_deal.png">
          <p class="p">资金明细</p>
        </div>
        <div class="linear"></div>
        <div @click="clickThis(2)"
             class="btn">
          <img class="img"
               src="./img/icon_new_betting_log.png">
          <p class="p">投注记录</p>
        </div>
      </div>
      <div class="btns">
        <div @click="clickThis(8)"
             class="btn">
          <img class="img"
               src="./img/daili_icon.png">
          <p class="p">我的代理</p>
        </div>
        <div class="linear"></div>
        <div @click="clickThis(3)"
             class="btn">
          <img class="img"
               src="./img/icon_new_mine_courtesy.png">
          <p class="p">额度转换</p>
        </div>
        <div class="linear"></div>
        <div @click="clickThis(4,false)"
             class="btn">
          <img class="img"
               src="./img/guide.png">
          <p class="p">新手教程</p>
      ...
      <div class="btns">
        <div @click="clickThis(5,false)"
             class="btn">
          <img class="img"
               src="./img/icon_new_mine_bankcard.png">
          <p class="p">客服</p>
        </div>
        <div class="linear"></div>
        <div @click="clickThis(6,false)"
             class="btn">
          <img class="img"
               src="./img/icon_new_mine_about.png">
          <p class="p">关于</p>
        </div>
        <div class="linear"></div>
        <div @click="clickThis(7)"
             class="btn">
          <img class="img"
               src="./img/icon_new_mine_proxy.png">
          <p class="p">安全中心</p>
        </div>
        <div class="linear"></div>
        <!-- <div @click="clickThis(8)" >
