            ...
            <div class="bank-box display-flex flex-center">
                <div class="bank-content display-flex align-center" :class="account.bankNumber?'has-card':'no-card'">
                    <div class="bank-body flex-1 display-flex justify-between has-card-body flex-column" v-if="account.bankNumber">
                            <div class="title-box">
                                <div class="title-white-txt"><b>{{ account.bankName }}</b></div>
                                <div class="body-white-txt">储蓄卡</div>
                            </div>
                            <div class="chip-box"></div>
                            <div class="bottom-box">
                                <!-- <div class="small-white-txt">卡号</div> -->
                                <div class="card-num"><b class="card-content">{{ account.bankNumber | spliceCardNum }}</b></div>
                            </div>    
                    </div>
    ...
    .main-container{
        .bank-box{
            ...
            .bank-content{
                ...
                border-radius:10px;
                &.has-card{
                    background:linear-gradient(90deg,rgba(161,133,94,1) 0%,rgba(212,199,172,1) 100%);
                }
                &.no-card{
                    background:linear-gradient(90deg,rgba(161,133,94,1) 0%,rgba(212,199,172,1) 100%);
                }
