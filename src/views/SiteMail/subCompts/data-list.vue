    ...
    <div class="data-wrapper">
        <van-list v-model="moreLoading" :finished="finished" finished-text="没有更多了" @load="loadMore">
            <div class="data-content">
                <div class="item-msg display-flex align-center justify-between" :class="{'txt-black':v.isRead, 'txt-gray':v.isRead}" v-for="(v, k) in msgList" :key="k" @click="onMsgClick(v, k)">
                    <div>{{ v.title }}</div>
