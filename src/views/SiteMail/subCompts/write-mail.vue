<template>
    <div class="write-wrapper">
        <div class="item-form">
            <div class="form-title">标题&nbsp;<span style="color:red">*</span></div>
            <div class="input-box">
                <input maxlength="16" v-model="msgParam.title" class="text-input display-flex" type="text"  placeholder="请输入标题(最长输入16个字符)"/>
            </div>
        </div>
        <div class="item-form">
            <div class="form-title">内容&nbsp;<span style="color:red">*</span></div>
            <div class="input-box">
                <textarea maxlength="200" v-model="msgParam.content" class="text-area display-flex" placeholder="请输入内容(10-200字之间)"></textarea>
            </div>
        </div>
        <div class="item-form">
...
.write-wrapper{
    ...
    .item-form{
        ...
        .input-box{
            box-shadow: 0 4px 8px 0 rgba(2, 145, 254, .1);
            .text-input{
                height: 45px;
                padding: 0 10px;
                background: #ffffff;
