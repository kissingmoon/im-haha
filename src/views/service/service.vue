  ...
  <div class="service">
    ...
    <div v-else class="serviceTab">    
      ...
      <div v-if="item==1" class="left">
        ...
        <p class="p">{{OBJ.QQ1}}</p>
        <p class="p">QQ客服1</p>
        <div :data-clipboard-text="OBJ.QQ1" class="btn copy" @click="openWx">复制账号并打开</div>
      </div>
      <div v-if="item==1" class="right">
        <div class="img">
          <img style="width:100%;height:100%" src="./img/qq.png" alt="">
        ...
        <p class="p">{{OBJ.QQ2}}</p>
        <p class="p">QQ客服2</p>
        <div :data-clipboard-text="OBJ.QQ2" class="btn copy">复制账号并打开</div>
      </div>
      ...
      <div v-if="item==2" class="left">
        ...
        <p class="p">{{OBJ.MT1}}</p>
        <p class="p">MT客服1</p>
        <div :data-clipboard-text="OBJ.MT1" class="btn copy">复制账号并打开</div>
      </div>
      <div v-if="item==2" class="right">
        ...
        <p class="p">{{OBJ.MT2}}</p>
        <p class="p">MT客服2</p>
        <div :data-clipboard-text="OBJ.MT2" class="btn copy">复制账号并打开</div>
      </div>
    </div>
