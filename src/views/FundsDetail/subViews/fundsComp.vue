            ...
            <van-list v-model="moreLoading" :finished="finished" finished-text="没有更多了" @load="onLoad" :offset="30">
                <div class="list-content">
                    <div class="list-title--block display-flex flex-column flex-center">
                        ...
                        <div class="list-title__num" :class="{'txt-color__income': activeTab == 0,'txt-color__out':activeTab == 1}">
                    ...
                    <div class="list-data--block">
                        <div class="data-item display-flex align-center" v-for="(v,k) in recList" :key="k">
                            ...
                            <div class="item-col__right flex-1" :class="{'txt-color__income': activeTab == 0,'txt-color__out':activeTab == 1}">
                                {{ activeTab == 0?"+":"-"}}{{ v.money }}
                            </div>
                        </div>
                    </div>
